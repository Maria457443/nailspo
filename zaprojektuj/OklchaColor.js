...
export class OklchaColor {
	constructor(lightnessComponent, chromaComponent, hueComponent, alphaComponent,) {
	...
	convertToRgba() {
		...
		const convertedThis = new RgbaColor(
			...
			AlphaComponentOfRgbaColor.createFrom0To1Float(this.alphaComponent.value)
		);
